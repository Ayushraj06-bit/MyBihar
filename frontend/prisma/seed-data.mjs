...
export const places = [
  ...
  { name: 'Maurya Lok', type: 'Food', location: 'Dak Bungalow Chowk', latitude: 25.612700, longitude: 85.137600, description: 'The old shopping complex where the city eats litti chokha and chaat standing up.', image: '/litti.jpg', rating: 4.2, status: 'Open now' },
  ...
  { name: 'Rajgir', type: 'Hill Station', location: 'Nalanda', latitude: 25.028000, longitude: 85.420000, description: 'Hot springs, the ropeway to the Vishwa Shanti Stupa, and the Glass Bridge.', image: '/rajgir.jpg', rating: 4.6, status: 'Open now' },
  { name: 'Valmiki Tiger Reserve', type: 'Forest', location: 'West Champaran', latitude: 27.280000, longitude: 84.120000, description: "Bihar's only tiger reserve, along the Gandak at the foot of the Himalaya.", image: '/valmiki.jpg', rating: 4.5, status: 'Open now' },
  { name: 'Vikramshila', type: 'Places', location: 'Bhagalpur', latitude: 25.325000, longitude: 87.287000, description: 'The other great university of Pala Bihar, on the banks of the Ganga.', image: '/vikramshila.jpg', rating: 4.4, status: 'Open now' },
  { name: 'Kesaria Stupa', type: 'Places', location: 'East Champaran', latitude: 26.333300, longitude: 84.855600, description: 'The tallest stupa in the world, and one of the least visited.', image: '/kesaria.jpg', rating: 4.5, status: 'Open now' },
  { name: 'Barabar Caves', type: 'Places', location: 'Jehanabad', latitude: 25.005300, longitude: 85.063100, description: 'Ashoka-era caves cut into granite and polished like glass.', image: '/barabar.jpg', rating: 4.5, status: 'Open now' },
  { name: 'Ganga Ghats, Patna', type: 'Outdoors', location: 'Patna', latitude: 25.622000, longitude: 85.183000, description: 'The river walk from Gandhi Ghat to Digha, best at dusk.', image: '/ganga-ghat.jpg', rating: 4.4, status: 'Open now' }
]
